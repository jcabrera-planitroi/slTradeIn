...
public class PartnerController : CustomController
{
    ...
    public PartnerController(Detail_TTU_emailTemplate_Data detail_TTU_EmailTemplate_Data,
        Detail_TTU_userEmail_Data detail_TTU_UserEmail_Data,
        Detail_TTU_userEmailCampaign_Data detail_TTU_UserEmailCampaign_Data)
    {
